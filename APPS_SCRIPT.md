...
function doGet(e) {
  ...
  var loaderHtml = '<!DOCTYPE html><html><head>'
    ...
    + 'body{background:#0a1f0a;display:flex;align-items:center;justify-content:center;height:100vh;font-family:"Inter",system-ui,-apple-system,sans-serif;}'
    + '.loader-wrap{text-align:center;}'
    + '.spinner{width:40px;height:40px;margin:0 auto 20px;border:3px solid rgba(46,125,50,0.25);border-top-color:#43a047;border-radius:50%;animation:spin .8s linear infinite;}'
    + '@keyframes spin{to{transform:rotate(360deg)}}'
    + '.ld{color:#c8e6c9;font-size:1rem;font-weight:500;letter-spacing:.01em;}'
    + '.sub{color:#66bb6a;font-size:.8rem;margin-top:6px;}'
    + '</style>'
